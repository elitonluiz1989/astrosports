    ...
    <div class="dashboard__schedules-tabs">
        <ul class="nav nav-tabs" id="dashboard-schedules-content-tabs" role="tablist">
            <li class="nav-item" v-for="(item, key) in items" :key="key">
                <a :class="navLinkStyle(key)" :id="setTabId(key)" data-toggle="tab" :href="'#' + key" role="tab" :aria-controls="key" aria-selected="true" v-text="item"></a>
            </li>
        </ul>
        ...
        data() {
            return {
                items: {
                    "schedules": "Horários",
                    "poles": "Polos",
                    "catogories": "Categorias"
                },

                componentList: {
                    schedules: DashboardSchedulesList,
                    poles: null,
                    categories: null
                }
            };
