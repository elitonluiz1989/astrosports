...
@section('content')
    ...
    <div id="home-photos" class="home__galery home__wrapper carousel slide" data-ride="carousel">
        ...
        <!-- Controls -->
        <a class="float-left carousel-control" href="#home-photos" role="button" data-slide="prev">
            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="float-right carousel-control" href="#home-photos" role="button" data-slide="next">
